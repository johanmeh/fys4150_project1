...
The LU decomposition has a standard FLOP of $\frac{2}{3}n^{3}$. We would therefore expect the CPU time to be larger for LU decomposition than for Gaussian elimination. 
